      ...
      {showForm && (
        <form onSubmit={handleCreate}
          ...
          <div className="col-span-2 flex gap-2">
            ...
            <button type="button" onClick={() => setShowForm(false)} className="text-xs text-subtle hover:text-white px-3 py-2 transition-colors">
              Cancel
            </button>
          </div>
        </form>
              ...
              {filtered.map((lot) => (
                <tr key={lot.lot_id} className="border-b border-[rgba(255,255,255,0.02)] hover:bg-[rgba(0,212,255,0.02)] transition-colors">
                  ...
                  <td className="px-5 py-3.5 text-right">
                    <span className="text-[10px] px-2.5 py-0.5 rounded-full bg-[rgba(0,199,133,0.1)] text-emerald font-medium">
