...
TX_ACTION_SHARE_BOOKING = "share_booking"
TX_ACTION_SHARE_SETTLEMENT = "share_settlement"
TX_ACTION_SHARE_CANCELLATION = "share_cancellation"
TX_ACTIONS = {
...
RESIDENT_SHARE_ADOPTION_RATES = [0.05, 0.10, 0.15, 0.20, 0.25, 0.30]

# --- Vehicle registration pattern ---
VEHICLE_ID_PATTERN = r"^[A-Z]{2}[0-9]{2}[A-Z]{0,2}[0-9]{1,4}$"

# --- Permit types ---
PERMIT_MONTHLY = "monthly"
PERMIT_RATES = {PERMIT_MONTHLY: 50.0}

# --- Share listing statuses ---
SHARE_LISTING_ACTIVE = "active"
SHARE_LISTING_BOOKED = "booked"
SHARE_LISTING_CANCELLED = "cancelled"

# --- Share booking statuses ---
SHARE_BOOKING_ACTIVE = "active"
SHARE_BOOKING_COMPLETED = "completed"
SHARE_BOOKING_CANCELLED = "cancelled"
SHARE_PLATFORM_FEE = 0.10
